...
All commerce — catalog, cart, checkout, orders — flows through `@krafta/commerce`. Never compute a price, write your own cart/checkout logic, or call another backend.
