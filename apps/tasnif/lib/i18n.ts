...
const ru = {
  ...
  code: {
    back: "Новый поиск",
    metaTitle: "{code} — {name} · tasnif.krafta.uz",
    metaDescription: "Код ИКПУ {code}: {name}. Коды упаковки для чека, единица измерения и категория.",
...
const uz: Dictionary = {
  ...
  code: {
    back: "Yangi qidiruv",
    metaTitle: "{code} — {name} · tasnif.krafta.uz",
    metaDescription: "MXIK kodi {code}: {name}. Chek uchun qadoq kodlari, oʻlchov birligi va kategoriya.",
...
const en: Dictionary = {
  ...
  code: {
    back: "New search",
    metaTitle: "{code} — {name} · tasnif.krafta.uz",
    metaDescription: "IKPU code {code}: {name}. Package codes for the receipt, unit and category.",
