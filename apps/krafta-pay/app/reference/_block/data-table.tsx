...
// The row-detail Drawer is stubbed to Sheet: @base-ui/react 1.2.0 exports the
// drawer part as DrawerPreview only, so the registry's primitive is ahead of
// the library. Everything else in this reference is the block verbatim.
import {
  Sheet as Drawer,
