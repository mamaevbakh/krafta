...
const EN = {
  ...
  "testCards.subtitle": "Cards that move no money, for checking your checkout end to end.",
  ...
  "testCards.where": "Where to get them",
  "testCards.atmos.hint": "Issued with your test consumer key and store id when your Atmos sandbox is set up.",
  "testCards.uzum.hint": "Issued with your test terminal credentials in the Uzum merchant cabinet.",
...
const RU: Catalog = {
  ...
  "testCards.subtitle": "Карты, с которых не спишутся деньги — чтобы проверить оплату целиком.",
  ...
  "testCards.where": "Где их взять",
  "testCards.atmos.hint": "Выдаются вместе с тестовым consumer key и store id при настройке песочницы Atmos.",
  "testCards.uzum.hint": "Выдаются вместе с тестовым терминалом в кабинете продавца Uzum.",
...
const UZ: Catalog = {
  ...
  "testCards.subtitle": "Pul yechilmaydigan kartalar — to‘lovni boshdan-oxir tekshirish uchun.",
  ...
  "testCards.where": "Ularni qayerdan olish mumkin",
  "testCards.atmos.hint": "Atmos sinov muhiti sozlanganda sinov consumer key va store id bilan birga beriladi.",
  "testCards.uzum.hint": "Uzum sotuvchi kabinetida sinov terminali bilan birga beriladi.",
