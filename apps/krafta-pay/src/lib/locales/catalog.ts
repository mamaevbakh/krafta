...
const EN = {
  ...
  "checkout.payer.heading": "Who's paying?",
  "checkout.payer.hint":
    "Optional — so the seller knows the payment is from you and can reach you about it.",
  "checkout.payer.name": "Your name",
  "checkout.payer.phone": "Phone",
  ...
  "customers.noMatch": "No customer matches this.",
  "customers.open": "Open customer",
  "customers.badge.active": "{count} active",
  // "unpaid", not "needs action": the catalogue has no pluralisation, and a
  // noun agrees with 1 and 5 alike where a verb does not ("1 need action").
  "customers.badge.attention": "{count} unpaid",
  "customers.badge.inactive": "{count} inactive",
  "customers.tab.all": "All",
  ...
  "customers.add.description":
    "Someone you already know. You can start a subscription for them afterwards.",
  "customers.add.name": "Name",
  "customers.add.email": "Email",
  "customers.add.phone": "Phone",
  "customers.add.externalId": "Your own ID",
  "customers.add.externalIdHint":
    "Optional. If you already have an id for this person in your own system, put it here and the API will find them by it.",
  "customers.add.submit": "Add customer",
  "customers.add.saving": "Adding…",
  "customers.add.testMode": "This customer is added in test mode.",
  "customers.add.errorName": "Enter a name.",
  "customers.add.errorEmail": "That email doesn’t look right.",
  "customers.add.errorDuplicate": "You already have a customer with that ID.",
  "customers.add.errorGeneric": "Could not add the customer. Please try again.",
  "customer.name.edit": "Rename customer",
  "customer.name.save": "Save",
  "customer.name.cancel": "Cancel",
  "customer.name.placeholder": "How you know them",
  "customer.name.saveFailed": "Could not save the name",
  "customer.name.hint": "Only you see this. Use whatever you will recognise later.",
  ...
  "customer.stat.totalPaid": "Total paid",
  "customer.stat.activeSubs": "Active subscriptions",
  "customer.stat.outstanding": "Outstanding",
  "customer.startSub.cta": "Start a subscription",
  "customer.startSub.creating": "Creating…",
  "customer.startSub.hint":
    "Send this to the customer. Their subscription starts once they pay.",
  "customer.startSub.error": "Could not start the subscription. Please try again.",
...
const RU: Catalog = {
  ...
  "checkout.payer.heading": "Кто оплачивает",
  "checkout.payer.hint":
    "Необязательно — чтобы продавец видел, от кого платёж, и мог с вами связаться.",
  "checkout.payer.name": "Ваше имя",
  "checkout.payer.phone": "Телефон",
  ...
  "customer.unnamed": "Без имени",
  "customers.search": "Поиск по имени, почте или телефону",
  "customers.col.customer": "Клиент",
  ...
  "customers.noMatch": "Никого не нашли.",
  "customers.open": "Открыть клиента",
  // Русские числительные не согласуются с {count} без плюрализации, которой в
  // каталоге нет, — поэтому подписи, а не фразы: «Активных: 1» читается так же
  // ровно, как «Активных: 5».
  "customers.badge.active": "Активных: {count}",
  "customers.badge.attention": "К оплате: {count}",
  "customers.badge.inactive": "Неактивных: {count}",
  "customers.tab.all": "Все",
  ...
  "customers.add.description":
    "Тот, кого вы уже знаете. Подписку ему можно оформить следом.",
  "customers.add.name": "Имя",
  "customers.add.email": "Почта",
  "customers.add.phone": "Телефон",
  "customers.add.externalId": "Ваш ID",
  "customers.add.externalIdHint":
    "Необязательно. Если у вас в своей системе уже есть id этого человека, впишите его — по нему клиента будет находить API.",
  "customers.add.submit": "Добавить",
  "customers.add.saving": "Добавляем…",
  "customers.add.testMode": "Клиент добавится в тестовом режиме.",
  "customers.add.errorName": "Впишите имя.",
  "customers.add.errorEmail": "Почта выглядит неправильно.",
  "customers.add.errorDuplicate": "Клиент с таким ID у вас уже есть.",
  "customers.add.errorGeneric": "Не удалось добавить клиента. Попробуйте ещё раз.",
  "customer.name.edit": "Переименовать клиента",
  "customer.name.save": "Сохранить",
  "customer.name.cancel": "Отмена",
  "customer.name.placeholder": "Как вы его называете",
  "customer.name.saveFailed": "Не удалось сохранить имя",
  "customer.name.hint": "Видно только вам. Пишите так, как вам будет понятно.",
  ...
  "customer.stat.totalPaid": "Всего оплачено",
  "customer.stat.activeSubs": "Активных подписок",
  "customer.stat.outstanding": "К оплате",
  "customer.startSub.cta": "Оформить подписку",
  "customer.startSub.creating": "Создаём…",
  "customer.startSub.hint":
    "Отправьте ссылку клиенту. Подписка начнётся, как только он оплатит.",
  "customer.startSub.error": "Не удалось оформить подписку. Попробуйте ещё раз.",
...
const UZ: Catalog = {
  ...
  "checkout.payer.heading": "Kim to‘layapti",
  "checkout.payer.hint":
    "Ixtiyoriy — sotuvchi to‘lov kimdan kelganini bilishi va siz bilan bog‘lana olishi uchun.",
  "checkout.payer.name": "Ismingiz",
  "checkout.payer.phone": "Telefon",
  ...
  "customer.unnamed": "Nomsiz",
  "customers.search": "Ism, pochta yoki telefon bo‘yicha qidirish",
  "customers.col.customer": "Mijoz",
  ...
  "customers.noMatch": "Hech kim topilmadi.",
  "customers.open": "Mijozni ochish",
  "customers.badge.active": "{count} ta faol",
  "customers.badge.attention": "{count} ta to‘lanmagan",
  "customers.badge.inactive": "{count} ta nofaol",
  "customers.tab.all": "Hammasi",
  ...
  "customers.add.description":
    "Siz allaqachon biladigan odam. Obunani keyin rasmiylashtirasiz.",
  "customers.add.name": "Ism",
  "customers.add.email": "Pochta",
  "customers.add.phone": "Telefon",
  "customers.add.externalId": "Sizdagi ID",
  "customers.add.externalIdHint":
    "Ixtiyoriy. Agar o‘z tizimingizda bu odamning id’si bo‘lsa, shuni yozing — API uni shu bo‘yicha topadi.",
  "customers.add.submit": "Qo‘shish",
  "customers.add.saving": "Qo‘shilmoqda…",
  "customers.add.testMode": "Mijoz sinov rejimida qo‘shiladi.",
  "customers.add.errorName": "Ismni yozing.",
  "customers.add.errorEmail": "Pochta noto‘g‘ri ko‘rinadi.",
  "customers.add.errorDuplicate": "Bunday ID’li mijoz sizda allaqachon bor.",
  "customers.add.errorGeneric": "Mijozni qo‘shib bo‘lmadi. Qayta urinib ko‘ring.",
  "customer.name.edit": "Mijozni qayta nomlash",
  "customer.name.save": "Saqlash",
  "customer.name.cancel": "Bekor qilish",
  "customer.name.placeholder": "Uni qanday bilasiz",
  "customer.name.saveFailed": "Ismni saqlab bo‘lmadi",
  "customer.name.hint": "Buni faqat siz ko‘rasiz. O‘zingizga tushunarli qilib yozing.",
  ...
  "customer.stat.totalPaid": "Jami to‘langan",
  "customer.stat.activeSubs": "Faol obunalar",
  "customer.stat.outstanding": "To‘lanishi kerak",
  "customer.startSub.cta": "Obuna rasmiylashtirish",
  "customer.startSub.creating": "Yaratilmoqda…",
  "customer.startSub.hint":
    "Havolani mijozga yuboring. To‘lov o‘tishi bilan obuna boshlanadi.",
  "customer.startSub.error": "Obunani rasmiylashtirib bo‘lmadi. Qayta urinib ko‘ring.",
