...
const MATRIX: { group: string; rows: Row[] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Зал — QR на столах → на кухню", free: false, pro: true, business: true },
  ...
  },
  {
    group: "Скоро",
    rows: [
      { label: "Krafta Pay — оплата картой (зал + онлайн)", free: false, pro: false, business: "Скоро" },
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Pro — это полная система для одного заведения: зал (QR на столах), доставка с вызовом курьера, все заказы на одном экране. Business добавляет несколько заведений, роли команды, расширенную аналитику и приоритетную поддержку, а также первым получит Krafta Pay и AI-ассистента.",
  },
  {
