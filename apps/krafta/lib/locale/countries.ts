// ISO 3166-1 alpha-2 country/region codes (officially assigned). Names are
// resolved via Intl.DisplayNames at render time so the bundle stays small and
// users get region names in their own locale.
